...
CREATE TABLE chambre (
    ...
    exposition_chambre varchar(255),
...
CREATE TABLE reservation (
    ...
    montant_arrhes_res DECIMAL(5, 2),
    prix_total_res INT
);
ALTER TABLE station
ADD (PRIMARY KEY(num_station));
ALTER TABLE station
MODIFY num_station INT auto_increment NOT NULL;
ALTER TABLE client
ADD (PRIMARY KEY(num_client));
ALTER TABLE client
MODIFY num_client INT auto_increment NOT NULL;
ALTER TABLE hotel
ADD (
...
ALTER TABLE hotel
MODIFY num_hotel INT auto_increment NOT NULL;
ALTER TABLE chambre
ADD(
...
ALTER TABLE chambre
MODIFY num_chambre INT auto_increment NOT NULL;
